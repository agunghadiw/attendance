        ...
        <!-- page start-->
			...
			<s:token></s:token>
		  	<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.workflow"/></label>
			    <div class="col-sm-5">
			      <s:select cssClass="form-control" list="workflowList" listKey="workflowId" listValue="workflowSchemaModule" name="workflowIdX" headerKey="" headerValue="Select below"/>
			    </div>
				</div>
		  	<div class="form-group">
		  	...
		  	<div class="row">
      			...
      			<div class="col-md-6 text-right"><s:property value="%{pagerItem}" escape="false"/></div>
			        ...
			        <tr>
			        	<th>&nbsp;</th>
			          <th><s:text name="label.workflow"/></th>
			          <th><s:text name="label.name"/></th>
			          <th><s:text name="label.userGroup"/>/<s:text name="label.user"/></th>
...
%>
         		<tbody>
		            <s:iterator value="processList" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            <td><s:property value="workflow"/></td>
			            <td><s:property value="name"/></td>
			            <td><s:property value="userGroup.name"/>/<s:property value="user"/></td>
			            <td>
			            ...
			            <td>
			            	<a href="<s:url value="ProcessAction_detail.action"/>?processId=<s:property value="processId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                <a href="<s:url value="ProcessAction_edit.action"/>?processId=<s:property value="processId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="ProcessAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
