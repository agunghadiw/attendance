      ...
      <!--tab nav end-->
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-5">
		    		<s:submit cssClass="btn btn-sml" action="%{actionMethod}" onclick="selectAllOptions(document.getElementById('hrForm_availablePermissionIds'));selectAllOptions(document.getElementById('hrForm_choosenPermissionIds'));this.form.subaction.value='SAVE_ALL';" key="label.update.link" />
