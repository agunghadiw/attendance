        ...
        <!-- page start-->
			...
			<table class="table table-bordered table-striped">
				<thead>
			        <tr>
			        	<th>&nbsp;</th>
			          <th><s:text name="label.workflowSchemaModule"/></th>
...
%>
         		<tbody>
		            <s:iterator value="workflowList" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            <td><s:property value="workflowSchemaModule"/></td>
			            <td>
			            ...
			            <td>
			            	<a href="<s:url value="WorkflowAction_detail.action"/>?workflowId=<s:property value="workflowId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                <a href="<s:url value="WorkflowAction_edit.action"/>?workflowId=<s:property value="workflowId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="WorkflowAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
