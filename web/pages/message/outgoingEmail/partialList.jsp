        ...
        <!-- page start-->
			...
			<s:token></s:token>
		 	<div class="form-group">
		    	<label class="col-sm-2 control-label"><s:text name="label.to"/></label>
			    <div class="col-sm-3">
			      <s:textfield cssClass="form-control" name="toX" />
			    </div>
		  	</div>
		  	<div class="form-group">
		    	<label class="col-sm-2 control-label"><s:text name="label.subject"/></label>
			    <div class="col-sm-4">
			      <s:textfield cssClass="form-control" name="subjectX" />
			    </div>
			    <div class="col-sm-5">
			...
			<div class="table-responsive">
				...
				<thead>
			        <tr>
			          ...
			          <th><s:text name="label.emailDate"/></th>
			          <th><s:text name="label.sentDate"/></th>
			        </tr>
		        </thead>
        <%
int i = 0;
...
%>
         		<tbody>
            		<s:iterator value="outgoingEmailList" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            <td><s:property value="subject"/></td>
			            <td><s:property value="sender"/></td>
			            <td><s:property value="to"/></td>
			            <td><s:date name="emailDate" format="dd MMM yyyy"/></td>
			            <td><s:date name="sentDate" format="dd MMM yyyy"/></td>
		            </tr>
		           	</s:iterator>
         		</tbody>
  			</table>
