        ...
        <!-- page start-->
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-5">
		    		<s:submit cssClass="btn btn-sml" action="%{actionMethod}" onclick="selectAllOptions(document.getElementById('hrForm_availableBranchIds'));selectAllOptions(document.getElementById('hrForm_choosenBranchIds'));" key="label.update.link" />
					<input type="button" class="btn btn-sml" value="<s:text name="label.cancel.link"/>" onclick="window.location.href=('<s:url value="AttendanceMachineAction_cancel.action"/>');"/>
		    	</div>
			</div>
  			</s:form>
