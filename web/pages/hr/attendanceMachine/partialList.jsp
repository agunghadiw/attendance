        ...
        <!-- page start-->
			...
			<s:token></s:token>
		  	<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.machineId"/></label>
			    <div class="col-sm-5">
			      <s:textfield cssClass="form-control" name="machineIdX" />
			    </div>
			    <div class="col-sm-5">
			...
			<table class="table table-bordered table-striped">
				<thead>
			        <tr>
			        	<th>&nbsp;</th>
			          <th><s:text name="label.machineId"/></th>
...
%>
         		<tbody>
		            <s:iterator value="attendanceMachineLists" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            ...
			            <td>
			            	<a href="<s:url value="AttendanceMachineAction_detail.action"/>?attendanceMachineId=<s:property value="attendanceMachineId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                	<a href="<s:url value="AttendanceMachineAction_edit.action"/>?attendanceMachineId=<s:property value="attendanceMachineId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="AttendanceMachineAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
