			...
			<s:token></s:token>
		  	<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.leaveType"/></label>
					<div class="col-sm-5">
			      <s:select cssClass="form-control" name="leaveTypeX" list="leaveTypes" headerKey="" headerValue="Select below" />
			    </div>
			    <div class="col-sm-5">
			...
			<table class="table table-bordered table-striped">
				<thead>
			        <tr>
			        	...
			        	<th><s:text name="label.orderSeq"/></th>
			          <th><s:text name="label.leaveType"/></th>
			          <th><s:text name="label.leaveFrom"/>-<s:text name="label.leaveTo"/></th>
			          <th><s:text name="label.leaveUnit"/></th>
			          <th><s:text name="label.deductionProcentage"/></th>
			          <th>&nbsp;</th>
			        </tr>
		        </thead>
        <%
...
%>
         		<tbody>
		            <s:iterator value="leaveDeductions" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            <td><s:property value="code"/></td>
			            <td><s:property value="orderSeq"/></td>
			            <td><s:property value="leaveType"/></td>
			            <td><s:property value="leaveFrom" />&nbsp;-&nbsp;<s:property value="leaveTo" /></td>
			            <td><s:property value="leaveUnit"/></td>
			            <td align="right"><s:property value="%{getText('format.rate.number',{deductionProcentage})}" />%</td>
			            <td>
			            	<a href="<s:url value="LeaveDeductionAction_detail.action"/>?leaveDeductionId=<s:property value="leaveDeductionId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                	<a href="<s:url value="LeaveDeductionAction_edit.action"/>?leaveDeductionId=<s:property value="leaveDeductionId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="LeaveDeductionAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
