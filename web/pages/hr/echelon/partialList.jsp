...
%>
         		<tbody>
		            <s:iterator value="echelons" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            <td><s:property value="level"/></td>
			            <td><s:property value="name"/></td>
			            <td>
			            	<a href="<s:url value="EchelonAction_detail.action"/>?echelonId=<s:property value="echelonId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                	<a href="<s:url value="EchelonAction_edit.action"/>?echelonId=<s:property value="echelonId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="EchelonAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
