        ...
        <!-- page start-->
			...
			<s:token></s:token>
		  	<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.degreeType"/></label>
			    <div class="col-sm-3">
			      <s:select cssClass="form-control" name="degreeTypeX" list="degreeTypes" emptyOption="true" />
			    </div>
			</div>
		  	<div class="form-group">
			...
			<table class="table table-bordered table-striped">
				<thead>
			        <tr>
			        	<th>&nbsp;</th>
			        	<th><s:text name="label.degreeType"/></th>
...
%>
         		<tbody>
		            <s:iterator value="degreeLists" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            <td><s:property value="degreeType"/></td>
			            ...
			            <td>
			            	<a href="<s:url value="DegreeAction_detail.action"/>?degreeId=<s:property value="degreeId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                	<a href="<s:url value="DegreeAction_edit.action"/>?degreeId=<s:property value="degreeId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="DegreeAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
