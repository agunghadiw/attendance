        ...
        <!-- page start-->
			...
			<s:token></s:token>
		  	<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.dutyType"/></label>
			    <div class="col-sm-5">
			      <s:select cssClass="form-control" name="dutyTypeX" list="dutyTypes" headerKey="" headerValue="Select below" />
			    </div>
				</div>
		  	<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.task"/></label>
			    <div class="col-sm-5">
			      <s:textfield cssClass="form-control" name="taskX" />
			    </div>
				</div>
				<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.dutyDate"/></label>
			    <div class="col-sm-3">
		    		<div class="input-group">
		    			<s:textfield cssClass="datePicker form-control" id="fromDutyDateX" name="fromDutyDateX" readonly="%{readOnly}" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
		    		</div>
		    	</div>
		    	<div class="col-sm-3">
		    		<div class="input-group">
		    			<s:textfield cssClass="datePicker form-control" id="toDutyDateX" name="toDutyDateX" readonly="%{readOnly}" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
		    		</div>
		    	</div>
			    <div class="col-sm-2">
			...
			<table class="table table-bordered table-striped">
				<thead>
			        <tr>
			        	<th>&nbsp;</th>
			          <th><s:text name="label.dutyType"/></th>
			          <th><s:text name="label.dutyDate"/></th>
			          <th><s:text name="label.task"/></th>
			          <th><s:text name="label.fromBranch"/></th>
			          <th><s:text name="label.toBranch"/></th>
			          <th><s:text name="label.totalEmployee"/></th>
			          <th>&nbsp;</th>
			        </tr>
		        </thead>
        <%
...
%>
         		<tbody>
		            <s:iterator value="employeeOutOfTownDuties" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            <td><s:property value="dutyType"/></td>
			            <td><s:date name="fromDate" format="dd MMM yyyy"/> - <s:date name="toDate" format="dd MMM yyyy"/></td>
			            <td><s:property value="task"/></td>
			            <td><s:property value="fromBranch"/></td>
			            <td><s:property value="toBranch"/></td>
			            <td align="right"><s:property value="employees" /></td>
			            <td>
			            	<a href="<s:url value="EmployeeOutOfTownDutyAction_detail.action"/>?employeeOutOfTownDutyId=<s:property value="employeeOutOfTownDutyId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                <a href="<s:url value="EmployeeOutOfTownDutyAction_edit.action"/>?employeeOutOfTownDutyId=<s:property value="employeeOutOfTownDutyId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="EmployeeOutOfTownDutyAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
