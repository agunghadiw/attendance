    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
		    		<s:select cssClass="form-control" list="leaveTypes" id="leaveType" name="leaveType" emptyOption="true" disabled="%{readOnly}"/>
		    	</div>
	  	</div>
			<div class="form-group">
	    		...
	    		<div class="input-group">
	    			<s:textfield cssClass="datePicker form-control" id="startDate" name="startDate" readonly="%{readOnly}" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
	    		</div>
	    	</div>
	    	<div class="col-sm-3">
	    		<div class="input-group">
	    			<s:textfield cssClass="datePicker form-control" id="endDate" name="endDate" readonly="%{readOnly}" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
	    		</div>
	    	</div>
			</div>
			<div class="form-group">
