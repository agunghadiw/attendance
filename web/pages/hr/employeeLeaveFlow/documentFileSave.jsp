...
<!--sidebar end-->
    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<s:token></s:token>
			<p class="text-center">Data telah disimpan.<br/>
			<p class="text-center">Silahkan klik tombol dibawah untuk melanjutkan.</p>
			<br>
			<br>
			<p class="text-center">
				<input type="button" class="btn btn-sml" value="<s:text name="label.home.link"/>" onclick="window.location.href=('<s:url value="/basic/UserAction_home.action"/>');"/>
  			</p>
  			</s:form>
