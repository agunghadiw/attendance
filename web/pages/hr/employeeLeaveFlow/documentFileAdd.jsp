...
<!--sidebar end-->
    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<s:form cssClass="form-horizontal" id="hrForm" enctype="multipart/form-data" method="POST">
			<s:hidden name="employeeLeaveId"/>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.leaveType"/></label>
				<div class="col-sm-5">
		    		<s:textfield cssClass="form-control" id="leaveType" name="leaveType" readonly="true" />
		    	</div>
	  	</div>
			<div class="form-group">
	    		...
	    		<div class="input-group">
	    			<s:textfield cssClass="form-control" id="startDate" name="startDate" readonly="true" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
	    		</div>
	    	</div>
	    	<div class="col-sm-3">
	    		<div class="input-group">
	    			<s:textfield cssClass="form-control" id="endDate" name="endDate" readonly="true" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
	    		</div>
	    	</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.leaveTime"/></label>
				<div class="col-sm-2">
	    		<div class="input-group bootstrap-timepicker">
               <s:textfield cssClass="form-control " id="startTime" name="startTime" readonly="true" />
           ...
           <button class="btn btn-default" type="button"><i class="fa fa-clock-o"></i></button>
	    	...
	    	<div class="col-sm-2">
	    		<div class="input-group bootstrap-timepicker">
               <s:textfield cssClass="form-control " id="endTime" name="endTime" readonly="true" />
           <span class="input-group-btn">
           <button class="btn btn-default" type="button"><i class="fa fa-clock-o"></i></button>
           </span>
           </div>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.note"/></label>
				<div class="col-sm-5">
		    		<s:textarea cssClass="form-control" id="note" name="note" readonly="true"  />
		    </div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.lastStatus"/></label>
				<div class="col-sm-5">
		    		<s:textfield cssClass="form-control" id="lastStatus" name="lastStatus" readonly="true" />
		    	</div>
	  	</div>
	  	<br/>
	  	<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.document"/></label>
				<div class="col-sm-5">
		    		<s:file cssClass="form-control" id="document" name="document" disabled="%{readOnly}" />
					<span class="help-block">File/Dokumen bukti pendukung ketidakhadiran</span>
		    	</div>
	  	</div>
			
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-5">
		    		<s:submit cssClass="btn btn-sml" action="%{actionMethod}" key="label.update.link" onclick="this.form.subaction.value='SAVE';"/>
		    		<s:submit cssClass="btn btn-sml" action="%{actionMethod}" key="label.updateAndClose.link" onclick="this.form.lastStatus.value='CLOSED';"/>
