			...
			<table class="table table-bordered table-striped">
				<thead>
			        <tr>
			          ...
			          <th><s:text name="label.days"/></th>
			          <th><s:text name="label.isDefaultShift"/></th>
			          <th>&nbsp;</th>
			        </tr>
		        </thead>
        <%
...
%>
         		<tbody>
		            <s:iterator value="workingShifts" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            ...
			            <td>
			            	<s:if test="(defaultShift==true)"><span class="label label-success"><s:text name="label.yes"/></span></s:if>
										<s:else><span class="label label-info"><s:text name="label.no"/></span></s:else>
			            </td>
			            <td>
			            	<a href="<s:url value="WorkingShiftAction_detail.action"/>?workingShiftId=<s:property value="workingShiftId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                	<a href="<s:url value="WorkingShiftAction_edit.action"/>?workingShiftId=<s:property value="workingShiftId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="WorkingShiftAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
