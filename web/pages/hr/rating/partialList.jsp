...
%>
         		<tbody>
		            <s:iterator value="ratings" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            <td><s:property value="code"/></td>
			            <td><s:property value="name"/></td>
			            <td align="right"><s:property value="%{getText('format.rate.number',{taxPph})}" />%</td>
			            <td>
			            	<a href="<s:url value="RatingAction_detail.action"/>?ratingId=<s:property value="ratingId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                	<a href="<s:url value="RatingAction_edit.action"/>?ratingId=<s:property value="ratingId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="RatingAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
