        ...
        <!-- page start-->
			...
			<s:token></s:token>
		  	<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.attendanceDate"/></label>
			    <div class="col-sm-3">
			    	<div class="input-group">
			      	<s:textfield cssClass="datePicker form-control" id="fromAttendanceDateX" name="fromAttendanceDateX" readonly="%{readOnly}" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
			    	</div>
			    </div>
			    <div class="col-sm-3">
			    	<div class="input-group">
			      	<s:textfield cssClass="datePicker form-control" id="toAttendanceDateX" name="toAttendanceDateX" readonly="%{readOnly}" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
			    	</div>
			    </div>
				</div>
		  	<div class="form-group">
			...
			<table class="table table-bordered table-striped">
				<thead>
			        <tr>
			          ...
			          <th><s:text name="label.attendanceDate"/></th>
...
%>
         		<tbody>
		            <s:iterator value="employeeAttendanceLists" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            ...
			            <td><s:date name="attendanceDate" format="dd MMM yyyy"/></td>
			            <td><s:property value="startTime"/></td>
			            <td><s:property value="endTime"/></td>
			            <td><s:property value="leaveType"/></td>
			            <td align="right"><s:property value="%{getText('format.number',{deductionAmount})}" /></td>
			            <td>
			            	<a href="<s:url value="EmployeeAttendanceAction_detail.action"/>?employeeAttendanceId=<s:property value="employeeAttendanceId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                <a href="<s:url value="EmployeeAttendanceAction_edit.action"/>?employeeAttendanceId=<s:property value="employeeAttendanceId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
