           ...
           <button class="btn btn-default" type="button"><i class="fa fa-clock-o"></i></button>
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-5">
					...
					<input type="button" class="btn btn-sml" value="<s:text name="label.cancel.link"/>" onclick="window.location.href=('<s:url value="EmployeeAttendanceAction_cancel.action"/>');"/>
		    	</div>
			</div>
  			</s:form>
