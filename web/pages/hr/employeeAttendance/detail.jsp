...
<!--sidebar end-->
    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<s:hidden name="employeeAttendanceId"/>
			...
			<div class="form-group">
	    		...
	    		<div class="input-group">
	    			<s:textfield cssClass="datePicker form-control" id="attendanceDate" name="attendanceDate" readonly="%{readOnly}" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
	    		</div>
	    	</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.attendanceTime"/></label>
				<div class="col-sm-2">
           ...
           <button class="btn btn-default" type="button"><i class="fa fa-clock-o"></i></button>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
		    		<s:textarea cssClass="form-control" id="note" name="note" readonly="%{readOnly}"  />
		    </div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.createBy"/></label>
				<div class="col-sm-5">
		    		<s:textfield cssClass="form-control" name="employeeAttendance.createBy" readonly="%{readOnly}" />
		    	</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.createOn"/></label>
				<div class="col-sm-5">
		    		<s:textfield cssClass="form-control" name="employeeAttendance.createOn" readonly="%{readOnly}" />
		    	</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.changeBy"/></label>
				<div class="col-sm-5">
		    		<s:textfield cssClass="form-control" name="employeeAttendance.changeBy" readonly="%{readOnly}" />
		    	</div>
			</div>
			<div class="form-group">
				<label  class="col-sm-3 control-label"><s:text name="label.changeOn"/></label>
				<div class="col-sm-5">
		    		<s:textfield cssClass="form-control" name="employeeAttendance.changeOn" readonly="%{readOnly}" />
		    	</div>
			</div>
			
			<div class="form-group">
					<div class="col-sm-offset-3 col-sm-5">
			    	<input type="button" class="btn btn-sml" value="<s:text name="label.edit.link"/>" onclick="window.location.href=('<s:url value="EmployeeAttendanceAction_edit.action"/>?employeeAttendanceId=<s:property value="employeeAttendanceId"/>');"/>&nbsp;
						<s:if test="(manual==true)">
						<input type="button" class="btn btn-sml" value="<s:text name="label.delete.link"/>" onclick="window.location.href=('<s:url value="EmployeeAttendanceAction_delete.action"/>?employeeAttendanceId=<s:property value="employeeAttendanceId"/>');"/>&nbsp;
						</s:if>
						<input type="button" class="btn btn-sml" value="<s:text name="label.back.link"/>" onclick="window.location.href=('<s:url value="EmployeeAttendanceAction_partialList.action"/>');"/>
			    </div>
				</div>
  			</s:form>
