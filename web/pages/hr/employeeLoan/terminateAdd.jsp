        ...
        <!-- page start-->
			...
			<div class="form-group">
	    		...
	    		<div class="input-group">
	    			<s:textfield cssClass="datePickerS form-control" id="loanDate" name="loanDate" readonly="true" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
	    		</div>
	    	</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-3">
		    		<s:textfield cssClass="form-control" id="loanAmount" name="loanAmount" readonly="true" />
		    </div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.duration"/></label>
				<div class="col-sm-1">
		    		<s:textfield cssClass="form-control" id="duration" name="duration" readonly="true"  />
		    </div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.outstandingLoan"/></label>
				<div class="col-sm-3">
		    		<s:textfield cssClass="form-control" id="outstandingLoan" name="outstandingLoan" readonly="true" />
		    </div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.paymentDate"/></label>
				<div class="col-sm-3">
		    	<div class="input-group">
	    			<s:textfield cssClass="datePicker form-control" id="paymentDate" name="paymentDate" readonly="true" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
	    		</div>
		    </div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.paymentAmount"/></label>
				<div class="col-sm-3">
		    		<s:textfield cssClass="form-control" id="paymentAmount" name="paymentAmount" readonly="%{readOnly}" />
		    </div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-5">
					...
					<input type="button" class="btn btn-sml" value="<s:text name="label.cancel.link"/>" onclick="window.location.href=('<s:url value="EmployeeLoanAction_cancel.action"/>');"/>
		    	</div>
			</div>
  			</s:form>
