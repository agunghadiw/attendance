    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
	    		<s:textfield cssClass="form-control" id="number" name="number" readonly="%{readOnly}" />
	    	</div>
	    	<div class="col-sm-4">
	    		<s:textfield cssClass="form-control" id="fullName" name="fullName" readonly="%{readOnly}" />
	    	</div>
			</div>
			<div class="form-group">
