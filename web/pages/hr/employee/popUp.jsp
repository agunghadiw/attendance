...
%>
         		<tbody>
		            ...
		            <tr>
			            <td><%=++i%>.</td>
			            <td>
			            	<a href="#" class="red" onclick="javascript:pick('<s:property value="employeeId"/>','<s:property value="number"/>','<s:property value="fullName"/>')">
...
function pick (a,b,c) {
	  //top.window.opener.focus();	  
		window.opener.document.getElementById('employeeId').value=a;
		window.opener.document.getElementById('number').value=b;
	  window.opener.document.getElementById('fullName').value=c;
	  window.close();
	  return false;
}
