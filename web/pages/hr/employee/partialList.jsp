    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-5">
			      <s:select list="branchs" cssClass="form-control" id="branchIdX" name="branchIdX" headerKey="" headerValue="Select below" listKey="branchId" listValue="name"/>
			    </div>
			</div>
			<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.position"/></label>
			    <div class="col-sm-5">
			      <s:select list="positions" cssClass="form-control" id="positionIdX" name="positionIdX" headerKey="" headerValue="Select below" listKey="positionId" listValue="name"/>
			    </div>
			</div>
			<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.degree"/></label>
			    <div class="col-sm-5">
			      <s:select list="degreeList" cssClass="form-control" id="degreeIdX" name="degreeIdX" headerKey="" headerValue="Select below" listKey="degreeId" listValue="name"/>
			    </div>
			</div>
			<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.echelon"/></label>
			    <div class="col-sm-5">
			      <s:select list="echelonList" cssClass="form-control" id="echelonIdX" name="echelonIdX" headerKey="" headerValue="Select below" listKey="echelonId" listValue="name"/>
			    </div>
			</div>
			<div class="form-group">
...
%>
         		<tbody>
		            <s:iterator value="employeeLists" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            ...
			            <td align="right"><s:property value="grade"/></td>
			            <td><s:property value="rating"/></td>
			            <td><s:property value="echelon"/></td>
			            <td>
			            	<a href="<s:url value="EmployeeAction_detail.action"/>?employeeId=<s:property value="employeeId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                <a href="<s:url value="EmployeeAction_edit.action"/>?employeeId=<s:property value="employeeId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="EmployeeAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
