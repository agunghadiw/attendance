    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.month"/></label>
				<div class="col-sm-3">
		    		<s:select cssClass="form-control" list="months" name="month" emptyOption="true" disabled="%{readOnly}"/>
		    	</div>
		  	</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.year"/></label>
				<div class="col-sm-1">
		    		<s:textfield cssClass="form-control" id="year" name="year" readonly="%{readOnly}" />
		    	</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.isEarlyCalculation"/></label>
				<div class="col-sm-5">
		    		<s:checkbox id="earlyCalculationDeleted" name="earlyCalculationDeleted" disabled="%{readOnly}" />&nbsp;<s:text name="label.yes"/>
		    	</div>
			</div>
			<div class="form-group">
