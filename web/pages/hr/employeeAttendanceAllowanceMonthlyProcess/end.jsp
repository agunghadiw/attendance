...
<!--sidebar end-->
    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<s:token></s:token>
			<p class="text-center">Thank you, current process already done.<br/>
			<p class="text-center">Continue to next process.</p>
			<br>
			<br>
			<p class="text-center">
				<input type="button" class="btn btn-sml" value="<s:text name="label.back.link"/>" onclick="window.location.href=('<s:url value="/basic/UserAction_home.action"/>');"/>
  			</p>
  			</s:form>
