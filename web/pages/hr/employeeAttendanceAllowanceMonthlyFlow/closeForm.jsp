        ...
        <!-- page start-->
		 ...
		 <div class="table-responsive">
	      ...
	      <tbody>
		    ...
		    <div class="col-sm-3">
					<div class="input-group">
		    		<s:textfield cssClass="form-control" id="performanceAchievement" name="performanceAchievement" readonly="true" placeHolder="Procentage" />
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-5">
		    		<s:submit cssClass="btn btn-sml" action="%{actionMethod}" key="label.close.link" onclick="this.form.lastStatus.value='CLOSED';" />
