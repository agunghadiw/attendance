        ...
        <!-- page start-->
			...
			<s:token></s:token>
		  	<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.level"/></label>
			    <div class="col-sm-5">
			      <s:textfield cssClass="form-control" name="levelX" />
			    </div>
			    <div class="col-sm-5">
...
%>
         		<tbody>
		            <s:iterator value="grades" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            <td><s:property value="level"/></td>
			            <td align="right"><s:property value="%{getText('format.number',{attendanceAllowance})}" /></td>
			            <td>
			            	<a href="<s:url value="GradeAction_detail.action"/>?gradeId=<s:property value="gradeId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                	<a href="<s:url value="GradeAction_edit.action"/>?gradeId=<s:property value="gradeId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
