    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.currentProcess"/></label>
				<div class="col-sm-5">
		    		<s:textfield cssClass="form-control" name="currentProcessView" readonly="true"/>
		    </div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label">
					<s:if test="(nextStep=='REVERT')"><s:text name="label.noteForPreviousProcess"/></s:if>
          <s:else><s:text name="label.noteForNextProcess"/></s:else>
				</label>
				<div class="col-sm-5">
		    		<s:textarea cssClass="form-control" id="nextMessage" name="nextMessage" readonly="%{readOnly}"  />
		    </div>
			</div>
