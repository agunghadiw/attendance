...
<!--sidebar end-->
    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<s:hidden name="employeeAttendanceAllowanceMonthlyReqId" />
			...
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.isUncompleteAttendance"/></label>
				<div class="col-sm-6">
		    		<s:checkbox name="uncompleteAttendance" disabled="%{readOnly}" />&nbsp;<s:text name="label.yes"/>
		    	</div>
			</div>
			<div class="form-group">
