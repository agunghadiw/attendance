...
<!--sidebar end-->
    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<s:token></s:token>
			<p class="text-center">Request has been submited.</p>
			<p class="text-center">Thank you.</p>
			<br>
			<br>
			<p class="text-center">
				<input type="button" class="btn btn-sml" value="<s:text name="label.back.link"/>" onclick="window.location.href=('<s:url value="/hr/EmployeeAttendanceAllowanceMonthlyAction_partialList.action"/>');"/>
  			</p>
  			</s:form>
