        ...
        <!-- page start-->
			...
			<table class="table table-bordered table-striped">
				<thead>
			        <tr>
			        	<th>&nbsp;</th>
			        	<th><s:text name="label.parent"/></th>
			          <th><s:text name="label.name"/></th>
			          <th><s:text name="label.tataUsaha"/></th>
			          <th>&nbsp;</th>
			        </tr>
		        </thead>
        <%
...
%>
         		<tbody>
		            <s:iterator value="positionLists" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            ...
			            <td>
			            	<ul>
			            	<s:iterator value="tataUsahas">
		                <li><s:property /></li>
		                </s:iterator>
		                </ul>
			            </td>
			            <td>
			            	<a href="<s:url value="PositionAction_detail.action"/>?positionId=<s:property value="positionId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                	<a href="<s:url value="PositionAction_edit.action"/>?positionId=<s:property value="positionId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="PositionAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
