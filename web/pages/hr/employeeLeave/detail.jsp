    ...
    <section id="main-content">
        ...
        <!-- page start-->
           ...
           <button class="btn btn-default" type="button"><i class="fa fa-clock-o"></i></button>
		    ...
		    <s:if test="(documentFileId!=null)">
		    <div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.documentFile"/></label>
				<div class="col-sm-2">
	    			<input class="btn btn-sml" type="button" onclick="window.open('<s:url value="/upload/UploadFileAction_showContent.action"/>?uploadFileId=<s:property value="documentFileId"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=800,height=600');return false;" value="<s:text name="label.download.link"/>">
	    		</div>
			</div>
			</s:if>
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-5">
		    		<input type="button" class="btn btn-sml" value="<s:text name="label.back.link"/>" onclick="window.location.href=('<s:url value="EmployeeLeaveAction_cancel.action"/>');"/>
		    	</div>
			</div>
  			</s:form>
