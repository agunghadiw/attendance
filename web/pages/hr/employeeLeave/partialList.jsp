        ...
        <!-- page start-->
			...
			<s:token></s:token>
		  	<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.leaveType"/></label>
			    <div class="col-sm-3">
			      <s:select cssClass="form-control" name="leaveTypeX" list="leaveTypes" emptyOption="true" />
			    </div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.leaveDate"/></label>
			    <div class="col-sm-3">
		    		<div class="input-group">
		    			<s:textfield cssClass="datePicker form-control" id="startDateX" name="startDateX" readonly="%{readOnly}" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
		    		</div>
		    	</div>
		    	<div class="col-sm-3">
		    		<div class="input-group">
		    			<s:textfield cssClass="datePicker form-control" id="endDateX" name="endDateX" readonly="%{readOnly}" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
		    		</div>
		    	</div>
			    <div class="col-sm-2">
			...
			<table class="table table-bordered table-striped">
				<thead>
			        <tr>
			          ...
			          <th><s:text name="label.leaveType"/></th>
			          <th><s:text name="label.startDate"/></th>
			          <th><s:text name="label.endDate"/></th>
			          <th><s:text name="label.startTime"/></th>
			          <th><s:text name="label.endTime"/></th>
			          <th><s:text name="label.lastStatus"/></th>
			          <th>&nbsp;</th>
			        </tr>
		        </thead>
        <%
...
%>
         		<tbody>
		            <s:iterator value="employeeLeaveLists" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            ...
			            <td><s:property value="leaveType"/></td>
			            <td><s:date name="startDate" format="dd MMM yyyy"/></td>
			            <td><s:date name="endDate" format="dd MMM yyyy"/></td>
			            <td><s:property value="startTime"/></td>
			            <td><s:property value="endTime"/></td>
			            <td><s:property value="lastStatus"/></td>
			            <td>
			            	<a href="<s:url value="EmployeeLeaveAction_detail.action"/>?employeeLeaveId=<s:property value="employeeLeaveId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                <!-- 
		                <a href="<s:url value="EmployeeLeaveAction_edit.action"/>?employeeLeaveId=<s:property value="employeeLeaveId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            	-->
			            </td>
		            </tr>
		            </s:iterator>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="GradeAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
		  	-->
