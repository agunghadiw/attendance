			...
			<table class="table table-bordered table-striped">
				<thead>
			        <tr>
			          ...
			          <th><s:text name="label.taskDate"/></th>
			          <th><s:text name="label.employee"/></th>
...
%>
         		<tbody>
		            <s:iterator value="userHomeTaskList" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            <td><a href='..<s:property value="link"/>?processId=<s:property value="processId"/>&id=<s:property value="id"/>' class=""><s:property value="processName"/></a></td>
			            <td><s:date name="processDate" format="dd MMM yyyy HH:mm"/></td>
			            <td><s:property value="number"/> - <s:property value="fullName"/></td>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="/basic/UserAction_home.action"/>');" value="<s:text name="label.home.link"/>">
		  	</div>
