    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<s:select cssClass="form-control" id="machineId" name="machineId" list="attendanceMachines" listKey="machineId" listValue="machineId" headerKey="" headerValue="Select below" disabled="%{readOnly}" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.file"/></label>
				<div class="col-sm-5">
					<s:file cssClass="form-control" id="uploadFile" name="uploadFile" disabled="%{readOnly}" />
					<span class="help-block">File backup mesin absen.</span>
				</div>
			</div>
				...
				<div class="form-group">
					<div class="col-sm-offset-3 col-sm-5">
						<s:submit cssClass="btn btn-sml" action="%{actionMethod}" key="label.upload.link"/>
					</div>
				</div>
	  		</s:form>
