...
<!--sidebar end-->
    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<s:token></s:token>
			<p class="text-center">Jumlah data absensi : <s:property value="total"/>.</p>
			<p class="text-center">Jumlah data berhasil tersimpan : <s:property value="success"/>.</p>
			<p class="text-center">Jumlah data gagal tersimpan : <s:property value="error"/>.</p>
