			...
			<table class="table table-bordered table-striped">
				<thead>
			        <tr>
			          ...
			          <th><s:text name="label.totalAmount"/></th>
...
%>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.open('<s:url value="/report/EmployeeAttendanceAllowancePaymentReportAction_excelList.action"/>?month=<s:property value="month"/>&year=<s:property value="year"/>&branchId=<s:property value="branchId"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=800,height=600');return false;" value="<s:text name="label.printed.link"/>">
		  	</div>
