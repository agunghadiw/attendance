			...
			<table class="table table-bordered table-striped">
				<thead>
			        <tr>
			          ...
			          <th><s:text name="label.totalAttendanceAllowance"/></th>
			          <th><s:text name="label.totalTaxPph"/></th>
...
%>
         		<tbody>
		            ...
		            <tr>
			            ...
			            <td align="right"><s:property value="totalEmployee"/></td>
			            <td align="right"><s:property value="%{getText('format.number',{attendanceAllowance})}" /></td>
			            <td align="right"><s:property value="%{getText('format.number',{totalAttendanceAllowance})}" /></td>
			            <td align="right"><s:property value="%{getText('format.number',{totalTaxPph})}" /></td>
