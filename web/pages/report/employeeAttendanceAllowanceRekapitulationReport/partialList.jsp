...
%>
         		<tbody>
		            ...
		            <tr>
			            ...
			            <td align="right"><s:property value="%{getText('format.number',{totalWithoutLoan})}" /></td>
		            </tr>
		            </s:iterator>
		        </tbody>
		  	</table>
