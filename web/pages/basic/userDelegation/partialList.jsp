        ...
        <!-- page start-->
			...
			<div class="table-responsive">
				...
				<thead>
			        <tr>
			        	<th>&nbsp;</th>
			          <th><s:text name="label.fromUser"/></th>
			          <th><s:text name="label.toUser"/></th>
...
%>
         		<tbody>
            		<s:iterator value="userDelegationList" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            ...
			            <td>
			            	<a href="<s:url value="/basic/UserDelegationAction_detail.action"/>?userDelegationId=<s:property value="userDelegationId"/>"><i class="fa fa-search-minus" title="Edit"></i></a>&nbsp;
		                	<a href="<s:url value="/basic/UserDelegationAction_edit.action"/>?userDelegationId=<s:property value="userDelegationId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		           	</s:iterator>
         		</tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		    	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="/basic/UserDelegationAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
