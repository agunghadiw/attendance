...
<!--sidebar end-->
    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<s:hidden name="userDelegationId"/>
        ...
        <s:actionerror/><s:fielderror></s:fielderror><s:actionmessage/>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.fromUser"/></label>
				<div class="col-sm-5">
		    	<s:textfield cssClass="form-control" name="fromUser" readonly="%{readOnly}" />
		    	</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.toUser"/></label>
				<div class="col-sm-5">
		    	<s:textfield cssClass="form-control" name="toUser" readonly="%{readOnly}" />
		    	</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.fromDate"/></label>
				<div class="col-sm-3">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.toDate"/></label>
				<div class="col-sm-3">
		    		<div class="input-group">
