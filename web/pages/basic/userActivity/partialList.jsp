        ...
        <!-- page start-->
			...
			<s:token></s:token>
		 	<div class="form-group">
		  	...
		  	<div class="form-group">
		    	<label class="col-sm-2 control-label"><s:text name="label.activity"/></label>
			    <div class="col-sm-4">
			      <s:textfield cssClass="form-control" name="viewNameX" />
			    </div>
			    <div class="col-sm-5">
			...
			<div class="table-responsive">
				...
				<thead>
			        <tr>
			          ...
			          <th><s:text name="label.activity"/></th>
			          <th><s:text name="label.activityDate"/></th>
			          <th><s:text name="label.ip"/></th>
			        </tr>
		        </thead>
        <%
int i = 0;
...
%>
         		<tbody>
            		<s:iterator value="userActivityList" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            <td><s:property value="userName"/></td>
			            <td><s:property value="activityName"/></td>
			            <td><s:date name="activityDate" format="dd MMM yyyy HH:mm"/></td>
