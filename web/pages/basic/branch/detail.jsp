...
<!--sidebar end-->
    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<s:hidden name="address.addressId"/>
        ...
        <s:actionerror/><s:fielderror></s:fielderror><s:actionmessage/>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.address1"/></label>
				<div class="col-sm-5">
		    	<s:textarea cssClass="form-control" name="address.address1" readonly="%{readOnly}" />
		    	</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.address2"/></label>
				<div class="col-sm-5">
		    	<s:textarea cssClass="form-control" name="address.address2" readonly="%{readOnly}" />
		    	</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.createBy"/></label>
				<div class="col-sm-5">
		    		<s:textfield cssClass="form-control" name="branch.createBy" readonly="%{readOnly}" />
		    	</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.createOn"/></label>
				<div class="col-sm-5">
		    		<s:textfield cssClass="form-control" name="branch.createOn" readonly="%{readOnly}" />
		    	</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.changeBy"/></label>
				<div class="col-sm-5">
		    		<s:textfield cssClass="form-control" name="branch.changeBy" readonly="%{readOnly}" />
		    	</div>
			</div>
			<div class="form-group">
				<label  class="col-sm-3 control-label"><s:text name="label.changeOn"/></label>
				<div class="col-sm-5">
		    		<s:textfield cssClass="form-control" name="branch.changeOn" readonly="%{readOnly}" />
		    	</div>
			</div>
			<br>
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-5">
					<input type="button" class="btn btn-sml" value="<s:text name="label.edit.link"/>" onclick="window.location.href=('<s:url value="BranchAction_edit.action"/>?branchId=<s:property value="branchId"/>');"/>&nbsp;
					<input type="button" class="btn btn-sml" value="<s:text name="label.delete.link"/>" onclick="window.location.href=('<s:url value="BranchAction_delete.action"/>?branchId=<s:property value="branchId"/>');"/>&nbsp;
					<input type="button" class="btn btn-sml" value="<s:text name="label.back.link"/>" onclick="window.location.href=('<s:url value="BranchAction_partialList.action"/>');"/>
				</div>
			</div>
  		</s:form>
