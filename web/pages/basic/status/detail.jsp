    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
		    		<s:select cssClass="form-control" list="statusTypeList" name="type" disabled="%{readOnly}"/>
		    	</div>
		  	</div>
		  	<div class="form-group">
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-5">
					<input type="button" class="btn btn-sml" value="<s:text name="label.edit.link"/>" onclick="window.location.href=('<s:url value="/basic/StatusAction_edit.action"/>?statusId=<s:property value="statusId"/>');"/>&nbsp;
					<input type="button" class="btn btn-sml" value="<s:text name="label.delete.link"/>" onclick="window.location.href=('<s:url value="/basic/StatusAction_delete.action"/>?statusId=<s:property value="statusId"/>');"/>&nbsp;
					<input type="button" class="btn btn-sml" value="<s:text name="label.back.link"/>" onclick="window.location.href=('<s:url value="/basic/StatusAction_partialList.action"/>');"/>
				</div>
			</div>
  			</s:form>
