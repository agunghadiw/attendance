...
%>
         <tbody>
            <s:iterator value="organizationList" status="sequence">
            <tr>
	            <td><%=++i%>.</td>
	            <td><s:property value="code"/></td>
	            <td><s:property value="name"/></td>
	            <td>
	            	<a href="<s:url value="OrganizationAction_detail.action"/>?organizationId=<s:property value="organizationId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
                <a href="<s:url value="OrganizationAction_edit.action"/>?organizationId=<s:property value="organizationId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
	            </td>
            </tr>
            </s:iterator>
         </tbody>
  		...
  		<div class="col-sm-offset-6 col-sm-6">
		      <input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="OrganizationAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  </div>
