		    ...
		    <div class="submaintab">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<div class="input-group">
										<s:textfield cssClass="datePicker form-control" id="sodDate" name="organizationSetup.sodDate" readonly="true" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="form-group">
					<div class="col-sm-offset-3 col-sm-5">
						<s:submit cssClass="btn btn-sml" action="%{actionMethod}" key="label.save.link" onclick="this.form.subaction.value='SAVE_ALL';"/>
					<input type="button" class="btn btn-sml" value="<s:text name="label.cancel.link"/>" onclick="window.location.href=('<s:url value="OrganizationAction_cancel.action"/>');"/>
					</div>
				</div>
	  		</s:form>
