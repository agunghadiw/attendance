        ...
        <!-- page start-->
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-3">
					<s:submit cssClass="btn btn-sml" action="%{actionMethod}" key="label.update.link" onclick="selectAllOptions(document.getElementById('hrForm_availablePermissionIds'));selectAllOptions(document.getElementById('hrForm_choosenPermissionIds'));"/>
					<input type="button" class="btn btn-sml" value="<s:text name="label.cancel.link"/>" onclick="window.location.href=('<s:url value="/basic/RoleAction_partialList.action"/>');"/>
				</div>
			</div>		  	
  			</s:form>
