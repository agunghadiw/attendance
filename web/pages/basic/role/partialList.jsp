    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<div class="form-group">
			    <label class="col-sm-2 control-label"><s:text name="label.roleName"/></label>
			    <div class="col-sm-5">
			      <s:textfield cssClass="form-control" name="roleNameX" placeHolder="Role Name" />
			    </div>
			    <div class="col-sm-5">
...
%>
         		<tbody>
	            <s:iterator value="roleList" status="sequence">
	            <tr>
		            <td><%=++i%>.</td>
		            <td><s:property value="roleName"/></td>
		            <td><s:if test="userGroup!=null"><s:property value="userGroup.name"/></s:if></td>
		            <td>
		            	<a href="<s:url value="/basic/RoleAction_detail.action"/>?roleId=<s:property value="roleId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
	                <a href="<s:url value="/basic/RoleAction_edit.action"/>?roleId=<s:property value="roleId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
		            </td>
	            </tr>
	            </s:iterator>
         		</tbody>
		      ...
		      <input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="/basic/RoleAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
