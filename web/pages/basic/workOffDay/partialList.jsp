        ...
        <!-- page start-->
			...
			<s:token></s:token>
		 	<div class="form-group">
		    	<label class="col-sm-2 control-label"><s:text name="label.eventName"/></label>
			    <div class="col-sm-5">
			      <s:textfield cssClass="form-control" name="eventNameX" />
			    </div>
		  	</div>
		  	<div class="form-group">
		    	<label class="col-sm-2 control-label"><s:text name="label.eventDate"/></label>
			    <div class="col-sm-3">
			      <div class="input-group">
		    			<s:textfield cssClass="datePicker form-control" id="eventDateX" name="eventDateX" readonly="true" placeholder="dd mmm yyyy"/><label for="date-picker-2" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
		    		</div>
			    </div>
			    <div class="col-sm-5">
			...
			<div class="table-responsive">
				...
				<thead>
			        <tr>
			        	<th>&nbsp;</th>
			          <th><s:text name="label.eventDate"/></th>
			          <th><s:text name="label.eventName"/></th>
...
%>
         		<tbody>
            		<s:iterator value="workOffDayList" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            <td><s:date name="eventDate" format="dd MMM yyyy "/></td>
			            <td><s:property value="eventName"/></td>
			            <td><s:property value="workOffDayType"/></td>
			            <td>
			            	<a href="<s:url value="/basic/WorkOffDayAction_detail.action"/>?workOffDayId=<s:property value="workOffDayId"/>"><i class="fa fa-search-minus" title="Edit"></i></a>&nbsp;
		                <a href="<s:url value="/basic/WorkOffDayAction_edit.action"/>?workOffDayId=<s:property value="workOffDayId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		           	</s:iterator>
         		</tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		    	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="/basic/WorkOffDayAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
