...
<!--sidebar end-->
    ...
    <section id="main-content">
        ...
        <!-- page start-->
		    ...
		    <label class="col-sm-2 control-label"><s:text name="label.role"/></label>
		    <div class="col-sm-5">
		      <s:select cssClass="form-control" list="roleList" name="roleIdx" listKey="roleId" listValue="roleName" headerKey="0" headerValue="Select below"/>
		    </div>
		  </div>
		  <div class="form-group">
	...
	%>
	         <tbody>
	            ...
	            <tr>
		            ...
		            <td><s:if test="organization!=null"><s:property value="organization.name"/></s:if></td>
		            <td>
		            	<ul>
		            	<s:iterator value="roles">
	                <li><s:property value="roleName"/></li>
	                </s:iterator>
	                </ul>
		            </td>
		            <td>
		            ...
		            <td>
		            	<a href="<s:url value="/basic/UserAction_detail.action"/>?userId=<s:property value="userId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
	                <a href="<s:url value="/basic/UserAction_edit.action"/>?userId=<s:property value="userId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
		            </td>
	            </tr>
	            </s:iterator>
	         </tbody>
  		...
  		<div class="col-sm-offset-6 col-sm-6">
		      <input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="/basic/UserAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  </div>
