    ...
    <section id="main-content">
        ...
        <s:actionerror/><s:fielderror></s:fielderror><s:actionmessage/>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<s:checkbox name="active" disabled="%{readOnly}" />&nbsp;<s:text name="label.yes"/>
				</div>
		  </div>
			</s:else>
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-4">
					...
					<input type="button" class="btn btn-sml" value="<s:text name="label.cancel.link"/>" onclick="window.location.href=('<s:url value="/basic/UserAction_partialList.action"/>');"/>
				</div>
			</div>			
  		</s:form>
