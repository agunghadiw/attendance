        ...
        <!-- page start-->
			...
			<s:if test="(hasActionErrors() || hasFieldErrors() || hasActionMessages() )">
		  	...
		  	<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.userPass"/>&nbsp;<s:text name="label.old"/></label>
				<div class="col-sm-5">
		    		<input type="text" class="form-control" name="oldPass" value="****************" readonly="readonly"/>
		    	</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.userPass"/>&nbsp;<s:text name="label.new"/></label>
				<div class="col-sm-5">
		    		<s:password cssClass="form-control" name="confirmUserPass" readonly="%{readOnly}"/>
		    	</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.confirm"/>&nbsp;<s:text name="label.userPass"/>&nbsp;<s:text name="label.new"/></label>
				<div class="col-sm-5">
		    		<s:password cssClass="form-control" name="confirmUserPass2" readonly="%{readOnly}"/>
		    		<span class="help-block"><s:text name="label.newUserPassAndConfirmNewUserPassMustMatch"/></span>
		    	</div>
			</div>
			<div class="form-group">
