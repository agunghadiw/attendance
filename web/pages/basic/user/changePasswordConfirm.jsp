...
<!--sidebar end-->
    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<s:token></s:token>
			<p class="text-center">Password anda telah diubah.</p>
			<p class="text-center">Silahkan klik <b>Logoff</b> untuk login kembali.</p>
			<br>
			<br>
			<p class="text-center">
				<input type="button" class="btn btn-sml" value="<s:text name="label.logoff.link"/>" onclick="window.location.href=('<s:url value="/basic/LogonAction_logoff.action"/>');"/>
  			</p>
  			</s:form>
