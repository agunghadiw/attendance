    ...
    <section id="main-content">
        ...
        <!-- page start-->
			...
			<div class="form-group">
				<label class="col-sm-3 control-label"><s:text name="label.category"/></label>
				<div class="col-sm-5">
		    		<s:select cssClass="form-control" list="lookupCategoryList" name="category" disabled="%{readOnly}"/>
		    	</div>
		  	</div>
		  	<div class="form-group">
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-5">
					<input type="button" class="btn btn-sml" value="<s:text name="label.edit.link"/>" onclick="window.location.href=('<s:url value="LookupAction_edit.action"/>?lookupId=<s:property value="lookupId"/>');"/>&nbsp;
					<input type="button" class="btn btn-sml" value="<s:text name="label.delete.link"/>" onclick="window.location.href=('<s:url value="LookupAction_delete.action"/>?lookupId=<s:property value="lookupId"/>');"/>&nbsp;
					<input type="button" class="btn btn-sml" value="<s:text name="label.back.link"/>" onclick="window.location.href=('<s:url value="LookupAction_partialList.action"/>');"/>
				</div>
			</div>
  			</s:form>
