        ...
        <!-- page start-->
			...
			<s:token></s:token>
				<div class="form-group">
				    <label class="col-sm-2 control-label"><s:text name="label.category"/></label>
				    <div class="col-sm-5">
				      <s:select cssClass="form-control" list="lookupCategoryList" name="lookupCategoryX" headerKey="" headerValue="Select below"/>
				    </div>
				</div>
		  	<div class="form-group">
...
%>
         		<tbody>
		            <s:iterator value="lookupList" status="sequence">
		            <tr>
			            <td><%=++i%>.</td>
			            ...
			            <td>
			            	<a href="<s:url value="LookupAction_detail.action"/>?lookupId=<s:property value="lookupId"/>"><i class="fa fa-search-minus" title="Detail"></i></a>&nbsp;
		                <a href="<s:url value="LookupAction_edit.action"/>?lookupId=<s:property value="lookupId"/>"><i class="fa fa-pencil" title="Edit"></i></a>
			            </td>
		            </tr>
		            </s:iterator>
		        </tbody>
  			...
  			<div class="col-sm-offset-6 col-sm-6">
		     	<input class="btn btn-sml" type="button" onclick="window.location.href=('<s:url value="LookupAction_add.action"/>');" value="<s:text name="label.new.link"/>">
		  	</div>
